...
import edu.zcs.com.educationsys.util.tools.BitmapCache;
import edu.zcs.com.educationsys.util.tools.BitmapCache.ImageCallback;
...
//		private TextView text;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			holder = new Holder();
			convertView = View.inflate(act, R.layout.item_image_grida, null);
		...
		holder.iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if ((BitmapUtils.drr.size() + selectTotal) < 9) {
					...
					if (item.isSelected) {
						holder.selected
								.setImageResource(R.drawable.icon_select);
//						holder.text.setBackgroundResource(R.drawable.bgd_relatly_line);
						selectTotal++;
